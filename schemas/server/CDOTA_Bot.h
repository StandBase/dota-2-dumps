class CDOTA_Bot
{
	...
	bool m_bIsTrialModeEnabled;
	bool m_bIsTaskLogicEnabled;
	...
	CountdownTimer m_UpdateTaskTimer;
	...
	GameTick_t m_nNearbyTreesUpdatedTick;
	...
	VectorWS m_vLastSeenLoc;
	VectorWS m_vRequestedBlinkLoc;
	GameTime_t m_fRequestedBlinkStart;
	GameTime_t m_fRequestedBlinkExpire;
	VectorWS m_vRequestedWardLocation;
	...
	float32 m_flNextTaskDistance;
	GameTime_t m_flTaskReconsiderTime;
	GameTime_t m_flPlannerStateExpiration;
	CountdownTimer m_UpdateDangerTimer;
