class CFuncMover : public CBaseModelEntity
{
	...
	CGameSoundEventName m_iszStartForwardSound;
	CGameSoundEventName m_iszLoopForwardSound;
	CGameSoundEventName m_iszStopForwardSound;
	CGameSoundEventName m_iszStartReverseSound;
	CGameSoundEventName m_iszLoopReverseSound;
	CGameSoundEventName m_iszStopReverseSound;
	CGameSoundEventName m_iszArriveAtDestinationSound;
	...
	FuncMoverMovementSummary_t m_movementSummary;
	bool m_bStopFromBeginStopTarget;
	bool m_bQueueStop;
